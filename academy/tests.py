...
class CourseTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.lesson = Lesson.objects.create(lesson_name="Python", course=self.course, owner=self.user)
...
class LessonTestCase(APITestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(username='user', email="test@gmail.com", password="password")
        self.course = Course.objects.create(course_name="Программист", owner=self.user)
        self.lesson = Lesson.objects.create(lesson_name="Python", course=self.course, owner=self.user, video_link='http://youtube.com/java_video')
        self.client.force_authenticate(user=self.user)
    ...
    def test_permission_denied_on_update_lesson(self):
        another_user = User.objects.create_user(username='user1', email="anotheruser@gmail.com", password="password")
